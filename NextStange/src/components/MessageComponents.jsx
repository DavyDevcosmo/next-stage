...
export const ShowSuccess = ({ userName, timer }) => {
    return (
        <div className=" inset-0 flex items-center justify-center z-50  ">
            ...
            <div className="bg-teste text-teste2 p-4 rounded-md relative w-full text-center ">
                <h2 className="text-3xl font-bold mb-2 ">Cadastro feito com sucesso!</h2>
                <p>Bem-vindo à NextStage {userName} !</p>
                <div className="absolute bottom-2 left-0 right-0">
                    <div className="w-full bg-neutral-900 h-1 rounded">
                        <div
                            className="bg-white -500 h-full rounded"
                            style={{ width: `${timer}%`, transition: 'width .05s' }}
                        />
                    </div>
                </div>
